...
func (r *ScalityUIComponentExposerReconciler) updateConfigMapData(
	...
	configMap.Annotations["ui.scality.com/managed-by"] = "scalityuicomponentexposer-controller"
	configMap.Annotations["ui.scality.com/last-updated"] = time.Now().Format(time.RFC3339)
