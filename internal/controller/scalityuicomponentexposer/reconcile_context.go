...
func asStateReducer[R reconciler.Resource](r *ScalityUIComponentExposerReconciler, reconcilerFactory func(ScalityUIComponentExposer, State) reconciler.ResourceReconciler[R], name string) StateReducer {
	return StateReducer{
